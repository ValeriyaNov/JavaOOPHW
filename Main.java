...
public class Main {
    public static void main(String[] args) {
        ...
        HotDrinkVedingMachine firstmachine = new HotDrinkVedingMachine();
        firstmachine.setGoods(goods);
        ...
        HotDrink wishHotDrink = firstmachine.getProduct(nameHotDrink, volumeHotDrink, temperatureHotDrink);
